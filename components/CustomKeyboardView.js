...
// Detecta se o dispositivo está rodando iOS
// Esta verificação é importante porque o comportamento do teclado é diferente entre iOS e Android
 ...
 * Envolve o conteúdo em um KeyboardAvoidingView e ScrollView para garantir que o usuário
 ...
 * @returns {JSX.Element} Componente que ajusta a visualização para lidar com o teclado
 */
export default function CustomKeyboardView({children, inChat}) {
    // Configurações condicionais baseadas no contexto de uso (chat ou outras telas)
    let kavConfig = {};
    let scrollViewConfig = {};
        
    // Aplica configurações específicas se estiver na tela de chat
    if(inChat){
        ...
        // Importante para que o conteúdo seja corretamente posicionado na tela de chat
